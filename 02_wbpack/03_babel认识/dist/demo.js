...
// babel本身可以作为一个独立工具，不和webpack等构建工具配置来单独使用（需先安装@babel/core 和 @babel/cli）

// 1. 示例代码
var names = ["桑昆", "端木元", "玉磬子"];
...
// 7.每个ES6语法安装对应插件过于麻烦，因此babel有preset（预设）,安装:npm i @babel/preset-env
